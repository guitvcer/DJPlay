<template>
  <router-link to="{ name: 'user_chat', params: { username: user.username } }" class="flex border hover:bg-gray-100 px-3 py-2 rounded mx-px sm:mx-1 dark:hover:bg-main" :title="title">
